  ...
  return (
    <PageShell width="wide">
      ...
      <PageHeader
        ...
        actions={<Badge tone={registryStatusTone(organisation.status)}>{statusLabel}</Badge>}
      />
        ...
        <div className="space-y-6">
          <Card padding="lg">
            ...
            <dl className="space-y-5">
              ...
              <RegistryField label={t("organisations.target_groups")} value={organisation.target_groups} />
              <RegistryField label={t("organisations.activity_description")} value={organisation.activity_description} />
              <RegistryField label={t("organisations.economic_activities")} value={organisation.economic_activities} />
            </dl>
          </Card>
          ...
          <Card padding="lg">
            ...
            <dl className="grid gap-5 sm:grid-cols-2">
              <RegistryField label={t("organisations.other_names")} value={organisation.names_in_other_languages} />
              <RegistryField label={t("organisations.other_short_names")} value={organisation.short_names_in_other_languages} />
            </dl>
          </Card>
        </div>
        ...
        <aside className="space-y-6">
          <Card>
            ...
            <dl className="space-y-4">
              ...
              <RegistryField label={t("organisations.registered")} value={date(organisation.registered_on)} />
              <RegistryField label={t("organisations.founding_assembly")} value={date(organisation.founding_assembly_on)} />
              <RegistryField label={t("organisations.status_changed")} value={date(organisation.status_changed_on)} />
            </dl>
          </Card>
            ...
            <div className="space-y-3 text-base text-ink">
              ...
              {organisation.email ? (
                <p className="flex gap-2">
                  ...
                  <a
                    className={`break-all ${REGISTRY_LINK_CLASSES}`}
              ...
              {website ? (
                <p>
                  <a
                    className={`inline-flex items-center gap-1.5 break-all ${REGISTRY_LINK_CLASSES}`}
                    href={website}
                    target="_blank"
                    rel="noreferrer"
                  >
          ...
          <Card padding="md" className="bg-surface-sunken shadow-none">
            ...
            <a
              className={`mt-3 inline-flex items-center gap-1.5 text-sm font-medium ${REGISTRY_LINK_CLASSES}`}
