...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    let query = supabase
      ...
      .select("id,institution_id,title,description,event_date,start_time,end_time,volunteers_needed,volunteers_signed_up,requirements,contact_person,contact_phone,is_past,created_at,institution:institutions(id, name, category, address:public_address, city)")
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const { data, error } = await supabase
      ...
      .select(
        "id,institution_id,title,description,event_date,start_time,end_time,volunteers_needed,volunteers_signed_up,requirements,contact_person,contact_phone,is_past,created_at,institution:institutions(id, name, category, address:public_address, city, lat:public_lat, lng:public_lng)"
      )
      .single();
